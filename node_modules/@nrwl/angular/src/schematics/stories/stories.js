    ...
    return (tree, context) => {
        ...
        return schematics_1.chain(moduleFilePaths.map((filePath) => {
            ...
            if (!declarationsPropertyAssignment) {
                context.logger.warn(literals_1.stripIndents `No stories generated because there were no components declared in ${filePath}. Hint: you can always generate stories later with the 'nx generate @nrwl/angular:stories --name=${projectName}' command`);
