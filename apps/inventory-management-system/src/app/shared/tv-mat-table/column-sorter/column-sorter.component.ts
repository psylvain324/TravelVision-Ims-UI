...
@Component({
  selector: 'travel-vision-ims-tv-mat-table-column-sorter, button[travel-vision-ims-tv-mat-table-column-sorter]',
...
export class ColumnSorterComponent implements OnInit, AfterViewInit {
  ...
  ngAfterViewInit(): void {
    this.elementRef.nativeElement.classList += 'tv-mat-button-no-input';
  }
